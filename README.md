                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Эмблема Физ. Атаки</td>
                            <td>Увеличивает физическую атаку и проникновение брони</td>
                        </tr>
                        <tr>
                            <td><div class="emblem-icon" style="background: linear-gradient(135deg, #006400, #004d00);"></div></td>
                            <td>Эмблема Танка</td>
                            <td>Повышает HP и защиту, увеличивая выживаемость</td>
                        </tr>
                        <tr>
                            <td><div class="emblem-icon" style="background: linear-gradient(135deg, #4B0082, #3a0066);"></div></td>
                            <td>Эмблема Бойца</td>
                            <td>Баланс между уроном и защитой, идеально для Дариуса</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <section class="skill-section">
            ...
            <div class="skills-grid">
                <div class="skill-card">
                    ...
                    <h3>Пассивная: Казнь</h3>
                    <p>Каждая атака накладывает на врага кровотечение. При 5 стаках, следующая атака нанесет дополнительный урон.</p>
                </div>
                <div class="skill-card">
                    <div class="skill-icon">1</div>
                    <h3>Крушащий Удар</h3>
                    <p>Дариус совершает мощный удар топором, нанося урон по области. Враги на краю зоны получают больше урона.</p>
                </div>
                <div class="skill-card">
                    <div class="skill-icon">2</div>
                    <h3>Разрубание</h3>
                    <p>Дариус совершает следующую базовую атаку с увеличенным уроном и замедляет врага.</p>
                </div>
                <div class="skill-card">
                    <div class="skill-icon">3</div>
                    <h3>Притяжение</h3>
                    <p>Дариус притягивает всех врагов перед собой, нанося урон и оглушая их.</p>
                </div>
                <div class="skill-card">
                    <div class="skill-icon">У</div>
                    <h3>Ультимативная: Ноксская Казнь</h3>
                    <p>Дариус прыгает к врагу и наносит сокрушительный удар. Если урон убивает врага, способность мгновенно перезаряжается.</p>
                </div>
            </div>
        </section>
    </div>
